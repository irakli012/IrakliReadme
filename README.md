...
- 💼 **Current Role:** .NET Developer at **PayUnicard**, specializing in high-load enterprise systems and QR-based mobile solutions.
- ⚙️ **Core Expertise:** Deep knowledge of **.NET 6 through .NET 10**, transitioning legacy **.NET Framework** apps to modern **.NET Core** & **Web APIs**.
- 🚀 **Architecture:** Scaling systems with **Microservices**, **Clean Architecture**, **MediatR**, and **Asynchronous Messaging**.
